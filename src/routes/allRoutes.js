...
// Bot builder
import NLUData from '../pages/BotBuilder/NLUData/index';
import BotConfig from '../pages/BotBuilder/Config/BotConfig';
...
const userRoutes = [
  // Bot builder
  { path: '/nlu-data', component: NLUData },
  { path: '/intent', component: EcommerceOrders },
  { path: '/entity', component: EcommerceOrders },
  { path: '/story', component: EcommerceOrders },
  { path: '/domain', component: EcommerceOrders },
  { path: '/bot-config', component: BotConfig },
  { path: '/training', component: EcommerceOrders },

  // Test
  { path: '/sentence', component: FormLayouts },
  { path: '/e2e', component: FormLayouts },

  { path: '/conversations', component: Chat },
  { path: '/analytic', component: DashboardSaas },
  { path: '/config', component: FormLayouts },
  { path: '/annotation', component: PagesFaqs },
