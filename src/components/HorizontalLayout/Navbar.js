            ...
            <Collapse isOpen={props.leftMenu} className="navbar-collapse" id="topnav-menu-content">
              <ul className="navbar-nav">
                ...
                <li className="nav-item dropdown">
                  ...
                  <div
                    className={classname('dropdown-menu mega-dropdown-menu dropdown-menu-left dropdown-mega-menu-xl', {
                      show: ui
                    })}
                  >
                    <Row>
                ...
                <li className="nav-item dropdown">
                  ...
                  <div className={classname('dropdown-menu', { show: app })}>
                    ...
                    <div className="dropdown">
                      ...
                      <div className={classname('dropdown-menu', { show: email })}>
                        ...
                        <div className="dropdown">
                          ...
                          >
                            <span key="t-email-templates">Templates</span> <div className="arrow-down"></div>
                          </Link>
                          <div
                    ...
                    <div className="dropdown">
                      ...
                      >
                        {props.t(' Ecommerce')} <div className="arrow-down"></div>
                      </Link>
                      <div
                        className={classname('dropdown-menu', {
                          show: ecommerce
                      ...
                      >
                        ...
                        <Link to="/ecommerce-product-detail" className="dropdown-item">
                    ...
                    <div className="dropdown">
                      ...
                      <div className={classname('dropdown-menu', { show: crypto })}>
                        ...
                        <Link to="/crypto-kyc-application" className="dropdown-item">
