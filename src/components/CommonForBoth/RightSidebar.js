      ...
      <SimpleBar style={{ height: '900px' }}>
        <div data-simplebar className="h-100">
          ...
          <div className="p-4">
                ...
                <div className="radio-toolbar imgopt-radio">
                  ...
                  <div className="d-flex gap-2 flex-wrap">
                    ...
                    <label htmlFor="leftsidebarThemebgimg1">
                      <imgage src={bgimg1} alt="sidebar bg image" width="90" className="themesideimage rounded" />
                    </label>
                    {'   '}
                    ...
                    <label htmlFor="leftsidebarThemebgimg2">
                      <imgage alt="sidebar bg image" width="90" className="themesideimage rounded" src={bgimg2} />
                    </label>
                    {'   '}
                    ...
                    <label htmlFor="leftsidebarThemebgimg3">
                      <imgage alt="sidebar bg image" width="90" className="themesideimage rounded" src={bgimg3} />
                    </label>
                    {'   '}
                    <input
                      type="radio"
                    ...
                    <label htmlFor="leftsidebarThemebgimg4">
                      <imgage alt="sidebar bg image" width="90" className="themesideimage rounded" src={bgimg4} />
                    </label>
                    {'   '}
            ...
            <Link to="//1.envato.market/skotereact" className="btn btn-primary btn-block mt-3" target="_blank">
