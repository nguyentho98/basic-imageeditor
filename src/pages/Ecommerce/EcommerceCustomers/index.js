...
import { getCustomers, addNewCustomer, updateCustomer, deleteCustomer } from 'store/e-commerce/actions';
  ...
  const handleTableChange = (type, { page, searchText }) => {
    setCustomerList(
      customers.filter(customer =>
        Object.keys(customer).some(key => customer[key].toLowerCase().includes(searchText.toLowerCase()))
      )
    );
  };
