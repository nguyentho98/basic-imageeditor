                    ...
                    <Row>
                                ...
                                <NavItem>
                                  ...
                                  >
                                    <img
                                      ...
                                      alt=""
                                      onClick={() => {
                                        imageShow(productImages[product.image], 1);
                                      }}
                                ...
                                <NavItem>
                                  ...
                                  >
                                    <img
                                      ...
                                      alt=""
                                      onClick={() => {
                                        imageShow(productImages[product.image], 2);
                                      }}
                                      className="img-fluid mx-auto d-block rounded"
                                    />
                                  </NavLink>
                                ...
                                <NavItem>
                                  ...
                                  >
                                    <img
                                      ...
                                      alt=""
                                      onClick={() => {
                                        imageShow(productImages[product.image], 3);
                                      }}
                                      className="img-fluid mx-auto d-block rounded"
                                    />
                                  </NavLink>
                      ...
                      <Col xl="6">
                        <div className="mt-4 mt-xl-3">
                          ...
                          <p className="text-muted mb-4">( {product.reviews} Customers Review )</p>

                          {!!product.isOffer && <h6 className="text-success text-uppercase">{product.offer} % Off</h6>}
                          <h5 className="mb-4">
                            Price :{' '}
                                ...
                                product.features.map((item, i) => (
                                  <div key={i}>
                                    <p className="text-muted">
                                      <i
                                        className={classnames(item.icon, 'font-size-16 align-middle text-primary me-2')}
                                      />
                                      {item.type && `${item.type}: `}
                                      {item.value}
                                    </p>
                              ...
                              product.colorOptions.map((option, i) => (
                                <Link to="#" className="active" key={i}>
                                  <div className="product-color-item border rounded">
                                    <img src={productImages[option.image]} alt="" className="avatar-md" />
                                  </div>
                                  <p>{option.color}</p>
                                </Link>
                              ))}
