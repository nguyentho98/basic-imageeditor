      ...
      <div className="page-content">
        ...
        <Container fluid>
          ...
          {!isEmpty(wallet) && (
            <Row>
              <Col xl="4">
                <WalletStats wallet={wallet} isMenu={isMenu} toggleMenu={toggleMenu} />
              </Col>
              <Col xl="8">
                <Row>
                  <Col sm="4">
                      ...
                      <CardBody>
                        <Media>
                          ...
                          <Media body>
                            ...
                            <h5 className="mb-0">
                              1.02356 BTC <span className="font-size-14 text-muted">= $ 9148.00</span>
                            </h5>
                          </Media>
                        </Media>
                      </CardBody>
                      ...
                      <CardBody>
                        <Media>
                          ...
                          <Media body>
                            ...
                            <h5 className="mb-0">
                              0.04121 ETH <span className="font-size-14 text-muted">= $ 8235.00</span>
                            </h5>
                          </Media>
                        </Media>
                      </CardBody>
                      ...
                      <CardBody>
                        <Media>
                          ...
                          <Media body>
                            ...
                            <h5 className="mb-0">
                              0.00356 BTC <span className="font-size-14 text-muted">= $ 4721.00</span>
                            </h5>
                          </Media>
                        </Media>
                      </CardBody>
          ...
          <Row>
            <Col lg="12">
              {!isEmpty(walletHistory) && (
                <WalletActivities walletHistory={walletHistory} activeTab={activeTab} toggleTab={toggleTab} />
              )}
            </Col>
          </Row>
        </Container>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(CryptoWallet));
