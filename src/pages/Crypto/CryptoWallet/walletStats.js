...
import { Card, CardBody, Col, Dropdown, DropdownItem, DropdownMenu, DropdownToggle, Media, Row } from 'reactstrap';
          ...
          <Col sm="6">
            <div className="text-sm-end mt-4 mt-sm-0">
              ...
              <h5>
                ...
                <span className="badge bg-success ms-2 align-bottom">{wallet.lastMonthDifferencePercent}</span>
              </h5>
            </div>
          </Col>
        </Row>
