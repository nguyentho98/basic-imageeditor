                ...
                <Card>
                  <CardBody>
                    <Media>
                      ...
                      <Dropdown direction="left" isOpen={this.state.isMenu} toggle={this.toggleMenu}>
                        ...
                        <TabPane tabId="3" id="exchange-tab" role="tabpanel">
                          <div className="float-right ms-2">
                            <h5 className="font-size-14">
                              <i className="bx bx-wallet text-primary font-size-16 align-middle me-1" /> $4235.23
                            </h5>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="text-center">
                              <Button type="button" color="secondary" className="w-md">
                                Exchange Coin
                              </Button>
                            </div>
                          </div>
