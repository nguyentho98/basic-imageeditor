                  ...
                  <CardBody>
                      ...
                      <Row className="justify-content-center">
                        <Col lg="10">
                          ...
                          <p className="text-muted mt-3">
                            Itaque earum rerum hic tenetur a sapiente delectus ut aut reiciendis perferendis asperiores
                            repellat.
                          </p>
                    ...
                    >
                      <div className="modal-content">
                        <ModalHeader toggle={this.togglemodal}>Verify your Account</ModalHeader>
                        <ModalBody>
                                    ...
                                    <Row>
                                      <Col lg="12">
                                        <FormGroup className="mb-3">
                                          ...
                                          <select className="form-select" id="kycselectcity-input">
                                  ...
                                  <div>
                                    <Form>
                                      <Row>
                                        <Col lg="12">
                                          <FormGroup className="mb-3">
                                            <Label htmlFor="kycemail-input">Email</Label>
                                            <Input
                                              type="email"
                                              className="form-control"
                                              id="kycemail-input"
                                          ...
                                          <FormGroup className="mb-3">
                                            <Label htmlFor="kycconfirmcode-input">Confirm code</Label>
                                            <Input
                                              type="email"
                                              className="form-control"
