        ...
        <div id="gen-ques-accordion" className="accordion custom-accordion">
          <div className="mb-3">
            ...
            >
              ...
              <i className={col1 ? 'mdi mdi-minus accor-plus-icon' : 'mdi mdi-plus accor-plus-icon'} />
            </Link>
          ...
          <div className="mb-3">
            ...
            >
              ...
              <i className={col2 ? 'mdi mdi-minus accor-plus-icon' : 'mdi mdi-plus accor-plus-icon'} />
            </Link>
          ...
          <div className="mb-3">
            ...
            >
              ...
              <i className={col3 ? 'mdi mdi-minus accor-plus-icon' : 'mdi mdi-plus accor-plus-icon'} />
            </Link>
          ...
          <div>
            ...
            >
              ...
              <i className={col4 ? 'mdi mdi-minus accor-plus-icon' : 'mdi mdi-plus accor-plus-icon'} />
            </Link>
