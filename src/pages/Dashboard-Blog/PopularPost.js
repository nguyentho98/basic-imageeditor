...
import { Card, CardBody, Col, DropdownMenu, DropdownToggle, UncontrolledDropdown } from 'reactstrap';
          ...
          <CardBody>
            <div className="d-flex">
              ...
              <UncontrolledDropdown className="ms-auto">
                <DropdownToggle className="text-muted font-size-14" color="white">
                ...
                <tbody>
                  {popularpost.map((popularpost, key) => (
                    <tr key={key}>
                      ...
                      <td>
                        <i className="bx bx-like align-middle me-1"></i> {popularpost.like}
                      </td>
                      <td>
                        <i className="bx bx-comment-dots align-middle me-1"></i> {popularpost.comment}
                      </td>
                      <td>
