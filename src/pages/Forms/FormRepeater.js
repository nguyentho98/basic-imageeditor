...
import { Row, Col, Card, CardBody, Form, Label, Input, Button, CardTitle, Container } from 'reactstrap';
...
const FormRepeater = () => {
  ...
  function handleRemoveRow(e, idx) {
    if (typeof idx != 'undefined') document.getElementById('addr' + idx).style.display = 'none';
  }
