            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Set heights using className like <code>.form-control-lg</code> and <code>.form-control-sm</code>.
                  </p>
                  <div>
                    <Row>
                      <Col lg={6}>
                ...
                <CardBody>
                  ...
                  <Row>
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14 mb-4">
                          <i className="mdi mdi-arrow-right text-primary mr-1"></i> Form Checkboxes
                        </h5>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14 mb-4">
                          <i className="mdi mdi-arrow-right text-primary mr-1"></i> Form Checkboxes Right
                        </h5>
                        <div className="form-check form-check-right mb-3">
                          <input type="checkbox" className="form-check-input" id="CustomCheck1" />
                          <label className="form-check-label">Form Checkbox Right</label>
                        </div>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14">
                          <i className="mdi mdi-arrow-right text-primary"></i> Form Checkboxes colors
                        </h5>
                        <p className="sub-header mb-4">
                          Add className <code>.form-check-* </code> for a color Checkboxes
                        </p>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14">
                          <i className="mdi mdi-arrow-right text-primary"></i> Form Checkboxes Outline
                        </h5>
                        <p className="sub-header mb-4">
                          Add className <code>.form-checkbox-outline</code> &<code>.form-check-* </code> for a color
                          Checkboxes
                        </p>
                        ...
                        <div>
                          <div className="form-check form-checkbox-outline form-check-primary mb-3">
                            ...
                            />
                            <label className="form-check-label" htmlFor="customCheck-outlinecolor1">
                          ...
                          <div className="form-check form-checkbox-outline form-check-success mb-3">
                            ...
                            />
                            <label className="form-check-label" htmlFor="customCheck-outlinecolor2">
                          ...
                          <div className="form-check form-checkbox-outline form-check-info mb-3">
                            ...
                            />
                            <label className="form-check-label" htmlFor="customCheck-outlinecolor3">
                          ...
                          <div className="form-check form-checkbox-outline form-check-warning mb-3">
                            ...
                            />
                            <label className="form-check-label" htmlFor="customCheck-outlinecolor4">
                          ...
                          <div className="form-check form-checkbox-outline form-check-danger">
                            ...
                            />
                            <label className="form-check-label" htmlFor="customCheck-outlinecolor5">
                ...
                <CardBody>
                  ...
                  <Row>
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14">
                          <i className="mdi mdi-arrow-right text-primary ms-1"></i> Form Radio colors
                        </h5>
                        <p className="sub-header mb-4">
                    ...
                    <Col xl={3} sm={6}>
                      <div className="mt-4">
                        <h5 className="font-size-14">
                          <i className="mdi mdi-arrow-right text-primary ms-1"></i> Form Radio Outline
                        </h5>
                        <p className="sub-header mb-4">
                          Add className <code>form-radio-outline</code> & <code>.form-radio-* </code> for a color
                          Checkboxes
                        </p>
                        ...
                        <div>
                          <div className="form-check form-radio-outline form-radio-primary mb-3">
                            <input
                              ...
                              defaultChecked
                            />
                            <label className="form-check-label" htmlFor="customRadiooutlinecolor1">
                          ...
                          <div className="form-check form-radio-outline form-radio-success mb-3">
                            <input
                              ...
                              defaultChecked
                            />
                            <label className="form-check-label" htmlFor="customRadiooutlinecolor2">
                          ...
                          <div className="form-check form-radio-outline form-radio-info mb-3">
                            <input
                              ...
                              defaultChecked
                            />
                            <label className="form-check-label" htmlFor="customRadiooutlinecolor3">
                              Radio Outline Info
                            </label>
                          </div>
                          <div className="form-check form-radio-outline form-radio-warning mb-3">
                            <input
                              ...
                              defaultChecked
                            />
                            <label className="form-check-label" htmlFor="customRadiooutlinecolor4">
                          ...
                          <div className="form-check form-radio-outline form-radio-danger mb-3">
                            <input
                              ...
                              defaultChecked
                            />
                            <label className="form-check-label" htmlFor="customRadiooutlinecolor5">
            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    A switch has the markup of a custom checkbox but uses the <code>.form-switch</code> class to render
                    a toggle switch. Switches also support the <code>disabled</code> attribute.
                  </p>
                  <Row>
                    <Col sm={6}>
                      <div>
            ...
            <Col lg={12}>
              <Card>
                <CardBody>
                  ...
                  <div>
                    <h5 className="font-size-14">
                      <i className="mdi mdi-arrow-right text-primary"></i> Default file input
                    </h5>
                    <div className="row">
                      <Col sm={6}>
                        <div className="mt-3">
                  ...
                  <div className="mt-4 pt-2">
                    <h5 className="font-size-14 mb-0">
                      <i className="mdi mdi-arrow-right text-primary"></i> Custom file input
                    </h5>
                  </div>
                    ...
                    <Col sm={6}>
                      <div className="mt-4">
                        <div>
                          ...
                          <div className="input-group mb-3">
                            <button className="btn btn-primary" type="button" id="inputGroupFileAddon03">
                              Button
                            </button>
                            <Input
                              type="file"
