                            ...
                            <Row>
                              <Col lg="12">
                                <div className="mb-3">
                                  ...
                                  <textarea id="basicpill-address-input1" className="form-control" rows="2" />
                                </div>
                              </Col>
                            </Row>
                          </Form>
                    ...
                    <div className="steps clearfix">
                      <ul>
                        ...
                        >
                          ...
                          >
                            <span className="number">2.</span> <span>Company Document</span>
                          </NavLink>
                        </NavItem>
                        <NavItem
                          className={classnames({
