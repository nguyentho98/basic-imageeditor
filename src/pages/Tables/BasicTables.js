                ...
                <CardBody>
                  <div className="table-responsive">
                    ...
                    <p className="card-title-desc">
                      Table cells in <code>&lt;tbody&gt;</code> inherit their alignment from <code>&lt;table&gt;</code>{' '}
                      and are aligned to the the top by default. Use the vertical align classes to re-align where
                      needed.
                    </p>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Use contextual className to color table rows or individual cells.
                  </CardSubtitle>
