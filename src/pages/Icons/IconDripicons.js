              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc mb-2">
                    Use <code>&lt;i className="dripicons-alarm"&gt;&lt;/i&gt;</code>.
                  </p>
                  ...
                  <Row className="icon-demo-content">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-align-center" /> dripicons-align-center
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-align-justify" /> dripicons-align-justify
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-align-left" /> dripicons-align-left
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-align-right" /> dripicons-align-right
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-down" /> dripicons-arrow-down
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-left" /> dripicons-arrow-left
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-right" /> dripicons-arrow-right
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-thin-down" /> dripicons-arrow-thin-down
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-thin-left" /> dripicons-arrow-thin-left
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-thin-right" /> dripicons-arrow-thin-right
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-arrow-thin-up" /> dripicons-arrow-thin-up
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-basketball" /> dripicons-basketball
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-battery-empty" /> dripicons-battery-empty
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-battery-full" /> dripicons-battery-full
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-battery-low" /> dripicons-battery-low
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-battery-medium" /> dripicons-battery-medium
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-brightness-low" /> dripicons-brightness-low
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-brightness-max" /> dripicons-brightness-max
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-brightness-medium" /> dripicons-brightness-medium
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-browser-upload" /> dripicons-browser-upload
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-chevron-down" /> dripicons-chevron-down
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-chevron-left" /> dripicons-chevron-left
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-chevron-right" /> dripicons-chevron-right
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-chevron-up" /> dripicons-chevron-up
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-cloud-download" /> dripicons-cloud-download
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-cloud-upload" /> dripicons-cloud-upload
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-contract-2" /> dripicons-contract-2
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-conversation" /> dripicons-conversation
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-device-desktop" /> dripicons-device-desktop
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-device-mobile" /> dripicons-device-mobile
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-device-tablet" /> dripicons-device-tablet
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-document-delete" /> dripicons-document-delete
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-document-edit" /> dripicons-document-edit
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-document-new" /> dripicons-document-new
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-document-remove" /> dripicons-document-remove
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-experiment" /> dripicons-experiment
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-flashlight" /> dripicons-flashlight
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-folder" /> dripicons-folder
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-folder-open" /> dripicons-folder-open
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-graduation" /> dripicons-graduation
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-graph-bar" /> dripicons-graph-bar
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-graph-line" /> dripicons-graph-line
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-information" /> dripicons-information
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-link-broken" /> dripicons-link-broken
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-loop" /> dripicons-media-loop
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-next" /> dripicons-media-next
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-pause" /> dripicons-media-pause
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-play" /> dripicons-media-play
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-previous" /> dripicons-media-previous
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-record" /> dripicons-media-record
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-shuffle" /> dripicons-media-shuffle
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-media-stop" /> dripicons-media-stop
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-microphone" /> dripicons-microphone
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-photo-group" /> dripicons-photo-group
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-shopping-bag" /> dripicons-shopping-bag
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-tag-delete" /> dripicons-tag-delete
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-tags" /> dripicons-tags
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-thumbs-down" /> dripicons-thumbs-down
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-time-reverse" /> dripicons-time-reverse
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-user-group" /> dripicons-user-group
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                    ...
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-view-list-large" /> dripicons-view-list-large
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-view-thumb" /> dripicons-view-thumb
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-volume-full" /> dripicons-volume-full
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-volume-low" /> dripicons-volume-low
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-volume-medium" /> dripicons-volume-medium
                    </Col>
                    <Col xl="3" lg="4" sm="6">
                      <i className="dripicons-volume-off" /> dripicons-volume-off
                    </Col>
                    <Col xl="3" lg="4" sm="6">
