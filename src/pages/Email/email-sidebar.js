...
import { Button, Modal, ModalHeader, ModalBody, ModalFooter, Input, Card, Media } from 'reactstrap';
      ...
      <Card className="email-leftbar">
        ...
        <div className="mail-list mt-4">
          <Link to="email-inbox" className="active">
            <i className="mdi mdi-email-outline me-2"></i> Inbox <span className="ml-1 float-end">(18)</span>
          </Link>
