            ...
            <Col lg={4}>
              <Card>
                <CardBody>
                  ...
                  <ReactApexChart options={options} series={series} type="line" height={280} className="apex-charts" />
                </CardBody>
              </Card>
                              ...
                              <td>
                                <div className="team">
                                  {map(
                                    ...
                                    (member, index) =>
                                      index < 2 && (
                                        <Link to="#" className="d-inline-block" key={index}>
                                          {member.userImg ? (
                                            <img
                                              src={images[member.userImg]}
                                              className="rounded-circle avatar-xs"
                                  ...
                                  {size(item.members) > 2 && (
                                    <Link to="#" className="team-member d-inline-block ms-1">
                                      <div className="avatar-xs">
