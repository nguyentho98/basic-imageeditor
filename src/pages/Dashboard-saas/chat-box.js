                  ...
                  <ul className="list-inline user-chat-nav text-end mb-0">
                    ...
                    <li className="list-inline-item  d-none d-sm-inline-block">
                      <Dropdown isOpen={this.state.settings_Menu} toggle={this.toggleSettings}>
                        <a className="dropdown-toggle btn nav-btn" ag="i" href="/#">
                    ...
                    <li className="list-inline-item">
                      <Dropdown isOpen={this.state.other_Menu} toggle={this.toggleOther}>
                        <a className="dropdown-toggle btn nav-btn" tag="i" href="/#">
                      ...
                      <li>
                        <div className="conversation-list">
                          <UncontrolledDropdown direction="left" className="ms-2">
                            <a className="dropdown-toggle" tag="i" href="/#">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1" /> 10:00
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className="right">
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1" /> 10:02
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li>
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1" /> 10:06
                            </p>
                          </div>
                        </div>
                      </li>
                      ...
                      <li className=" right">
                        <div className="conversation-list">
                          ...
                          <div className="ctext-wrap">
                            ...
                            <p className="chat-time mb-0">
                              <i className="bx bx-time-five align-middle me-1" /> 10:07
                            </p>
                          </div>
                        </div>
                      </li>
            ...
            <div className="p-3 chat-input-section">
              <Row>
                ...
                <div className="col-auto">
                  <Button type="submit" color="primary" className="chat-send w-md ">
