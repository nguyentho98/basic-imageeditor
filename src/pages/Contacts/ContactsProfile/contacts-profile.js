...
import { Card, CardBody, CardTitle, Col, Container, Media, Row, Table } from 'reactstrap';
                  ...
                  <Row>
                    <Col sm="4">
                      <div className="avatar-md profile-user-wid mb-4">
                        <img src={images[userProfile.img]} alt="" className="img-thumbnail rounded-circle" />
                      </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(withRouter(ContactsProfile));
