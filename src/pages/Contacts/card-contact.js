          ...
          <CardBody>
            {!user.img ? (
              <div className="avatar-sm mx-auto mb-4">
                <span
                  className={
                    'avatar-title rounded-circle bg-soft bg-' + user.color + ' text-' + user.color + ' font-size-16'
                  }
                >
                  {user.name.charAt(0)}
                </span>
              ...
              <div className="mb-4">
                <img className="rounded-circle avatar-sm" src={images[user.img]} alt="" />
              </div>
            )}
            ...
            <div>
              {map(
                ...
                (tag, index) =>
                  index < 2 && (
                    <Link to="#" className="badge bg-primary font-size-11 m-1" key={'_skill_' + user.id + index}>
                      {tag}
                    </Link>
                  )
              )}
