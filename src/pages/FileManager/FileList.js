...
import { Card, CardBody, Col, DropdownMenu, DropdownToggle, Form, Row, UncontrolledDropdown } from 'reactstrap';
          ...
          <Col xl={9} sm={6}>
            <Form className="mt-4 mt-sm-0 float-sm-end d-flex align-items-center">
              ...
              <UncontrolledDropdown className="mb-0" direction="right">
                <DropdownToggle color="white" className="btn btn-link text-muted mt-n2">
                  ...
                  <div className="">
                    ...
                    <div className="d-flex">
                      <div className="overflow-hidden me-auto">
                        ...
                        <p className="text-muted text-truncate mb-0">{myfiles.file} Files</p>
                      </div>
