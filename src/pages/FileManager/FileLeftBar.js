        ...
        <CardBody>
          <div className="d-flex flex-column h-100">
            <div className="mb-4">
              <div className="mb-3">
                <UncontrolledDropdown>
                  <DropdownToggle className="btn btn-light w-100" color="#eff2f7">
              ...
              <ul className="list-unstyled categories-list">
                <li>
                  <div className="custom-accordion">
                    <Link className="text-body fw-medium py-1 d-flex align-items-center" onClick={toggle} to="#">
                      <i className="mdi mdi-folder font-size-16 text-warning me-2"></i> Files{' '}
                    ...
                    <Collapse isOpen={isOpen}>
                      <div className="card border-0 shadow-none ps-2 mb-0">
                        <ul className="list-unstyled mb-0">
                          ...
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <span className="me-auto">Development</span> <i className="mdi mdi-pin ms-auto"></i>
                            </Link>
                          </li>
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                          ...
                          <li>
                            <Link to="#" className="d-flex align-items-center">
                              <span className="me-auto">Admin</span> <i className="mdi mdi-pin ms-auto"></i>
                            </Link>
                          </li>
                        </ul>
                      </div>
                ...
                <li>
                  <Link to="#" className="text-body d-flex align-items-center">
                    <i className="mdi mdi-share-variant font-size-16 me-2"></i> <span className="me-auto">Shared</span>{' '}
                ...
                <li>
                  <Link to="#" className="text-body d-flex align-items-center">
                    ...
                    <span className="badge bg-success rounded-pill ms-2">01</span>
                  </Link>
                </li>
              </ul>
            </div>
