...
import { getProjects, addNewProject, updateProject, deleteProject } from 'store/actions';
                  ...
                  <Table className="project-list-table table-nowrap align-middle table-borderless">
                    ...
                    <tbody>
                      {map(projects, (project, index) => (
                        <tr key={index}>
                          <td>
                            <img src={companies[project.img]} alt="" className="avatar-sm" />
                          </td>
                          <td>
                            <h5 className="text-truncate font-size-14">
                              <Link to={`/projects-overview/${project.id}`} className="text-dark">
                                {project.name}
                              </Link>
                            </h5>
                                ...
                                !member.img || member.img !== 'Null' ? (
                                  <div className="avatar-group-item" key={index}>
                                    <Link to="#" className="team-member d-inline-block" id="member1">
                                      <img src={images[member.img]} className="rounded-circle avatar-xs" alt="" />
                  ...
                  <Modal isOpen={modal} toggle={toggle}>
                    ...
                    <ModalBody>
                      <AvForm onValidSubmit={handleValidProjectSubmit}>
                        <Row form>
                          <Col xs={12}>
                            <AvField type="hidden" value={projectList.img || ''} name="img" />

                            <AvField type="hidden" value={projectList.team || ''} name="team" />
