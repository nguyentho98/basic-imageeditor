                ...
                <CardBody>
                  ...
                  <div className="">
                    <div className="mb-4">
                      ...
                      <Progress className="mb-2 progress-sm" value={25} color="primary" style={{ height: '5px' }} />
                    </div>
                    <div className="mb-4">
                      <h5 className="font-size-13">Progress md</h5>
                      <Progress className="mb-2" value={25} color="success" style={{ height: '20px', width: '40%' }} />
                    </div>
                    <div className="mb-4">
                      <h5 className="font-size-13">Progress lg</h5>
                      <Progress className="mb-2 progress-lg" value={50} color="warning" style={{ height: '50px' }} />
                    </div>
                    <div className="">
                      <h5 className="font-size-13">Progress md</h5>
                      <Progress className="mb-2 progress-xl" value={70} color="danger" style={{ height: '70px' }} />
                    </div>
                  </div>
                </CardBody>
              </Card>
              ...
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    ...
                    <code className="highlighter-rouge"> striped animated </code> to to animate the stripes right to
                ...
                <CardBody>
                  ...
                  <div className="">
                    <div className="custom-progess mb-5">
                      <Progress className="progress-sm" color="danger" value={84} max={100} />
                    ...
                    <div className="custom-progess mb-5">
                      <Progress className="progress-sm" color="primary" value={75} max={100} />
                      <div className="avatar-xs progress-icon">
                    ...
                    <div className="custom-progess mb-5">
                      <Progress className="progress-sm" color="info" value={62} max={100} />
                      <div className="avatar-xs progress-icon">
