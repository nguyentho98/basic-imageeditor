              ...
              <Card>
                <CardBody>
                  ...
                  <p className="card-title-desc">
                    Navigation drawers can toggle open or closed. Closed by default, the drawer opens temporarily above
                    all other content until a section is selected.
                  </p>
                  <Button color="primary" className="" onClick={toggleTopDrawer} disabled={open}>
                    Top
                  </Button>{' '}
                  <Button color="primary" className="" onClick={toggleBottomDrawer} disabled={open}>
                    Bottom
                  </Button>{' '}
                  <Button color="primary" className="" onClick={toggleLeftDrawer} disabled={open}>
                    Left
                  </Button>{' '}
                  <Button color="primary" className="" onClick={toggleRightDrawer} disabled={open}>
                    Right
                  </Button>{' '}
                </CardBody>
              </Card>
