                  ...
                  <Row>
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_1'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_12'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                            <i key={'active_12'} className="mdi mdi-star-outline text-primary" style={starStyle} />
                          }
                        />
                      </div>
                    </Col>
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ActiveComponent={
                            <i key={'active_2'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ActiveComponent={
                            <i key={'active_3'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ...
                          ActiveComponent={
                            <i key={'active_5'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_6'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_7'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_8'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          defaultRating={4}
                          ActiveComponent={
                            <i key={'active__9'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                            <i key={'active__09'} className="mdi mdi-star-outline text-muted" style={starStyle} />
                          }
                        />
                      </div>
                    </Col>
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <RatingTooltip
                          ...
                          ActiveComponent={
                            <i key={'active_10'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                    ...
                    <Col xl="3" md="4" sm="6">
                      <div className="p-4 text-center">
                        ...
                        <Rating
                          ...
                          //   }}
                          ActiveComponent={
                            <i key={'active_11'} className="mdi mdi-star text-primary" style={starStyle} />
                          }
                          InActiveComponent={
                            <i key={'active_11'} className="mdi mdi-star-outline text-muted" style={starStyle} />
                          }
