                    ...
                    <Col xl="4">
                      ...
                      <div className="control-group my-4">
                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="closeButton" value="checked" />
                        ...
                        <div className="form-check mb-2">
                          <input
                            ...
                            value="checked"
                          />
                          <Label className="form-check-label" htmlFor="addBehaviorOnToastClick">
                            Add behavior on toast click
                          </Label>
                        </div>

                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="debugInfo" value="checked" />
                          <Label className="form-check-label" htmlFor="debugInfo">
                            Debug
                          </Label>
                        </div>

                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="progressBar" value="checked" />
                        ...
                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="preventDuplicates" value="checked" />
                          <Label className="form-check-label" htmlFor="preventDuplicates">
                            Prevent Duplicates
                          </Label>
                        </div>

                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="addClear" value="checked" />
                          <Label className="form-check-label" htmlFor="addClear">
                            Add button to force clearing a toast, ignoring focus
                          </Label>
                        </div>

                        <div className="form-check mb-2">
                          <input type="checkbox" className="form-check-input" id="newestOnTop" value="checked" />
                          <Label className="form-check-label" htmlFor="newestOnTop">
                            Newest on top
                          </Label>
                        </div>
                      </div>
                  ...
                  <Row className="mt-4">
                    <Col md="12">
                      <div className="button-items">
                        ...
                        <Button type="button" color="danger" id="clearlasttoast">
                          Clear Last Toast
                        </Button>
                      </div>
                    </Col>
