                ...
                <CardBody>
                  ...
                  <div className="btn-group mb-2">
                    <ButtonDropdown isOpen={drp_secondary} toggle={() => setDrp_secondary(!drp_secondary)}>
                      <DropdownToggle caret color="primary" className="btn btn-primary btn-lg">
                  ...
                  <div className="btn-group mb-2">
                    <ButtonDropdown isOpen={drp_secondary_lg} toggle={() => setDrp_secondary_lg(!drp_secondary_lg)}>
                      <Button className="btn btn-secondary"> Large button &nbsp;</Button>
            ...
            <Col xl={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Trigger dropdown menus above elements by adding <code className="highlighter-rouge">.dropup</code>{' '}
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Add <code className="highlighter-rouge">.dropdown-menu-end</code> to a{' '}
