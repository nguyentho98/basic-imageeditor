...
import { Button, DropdownToggle, DropdownMenu, DropdownItem, ButtonDropdown } from 'reactstrap';
                        ...
                        <div>
                          ...
                          <div>
                            <div className="btn-group btn-group-example" role="group">
                              <button type="button" className="btn btn-outline-secondary w-xs">
                      ...
                      <div className="mt-4">
                        ...
                        <div className="button-items">
                          ...
                          <button type="button" className="btn btn-success  btn-label">
                            <i className="bx bx-check-double label-icon"></i> Success
                          </button>
                          ...
                          <button type="button" className="btn btn-light  btn-label">
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="button-items">
                    ...
                    <Button color="secondary" className="btn btn-secondary btn-sm ">
                      Small button
                    </Button>
                  </div>
                </CardBody>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <p className="mb-3 card-title-desc">
                    Add <code>.w-xs</code>, <code>.w-sm</code>, <code>.w-md</code> and <code> .w-lg</code> className for
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <div className="button-items">
                    <Button color="primary" className="btn btn-primary " data-toggle="button" aria-pressed="false">
                      Single toggle
                    </Button>
                  </div>
                </CardBody>
              ...
              <Card>
                <CardBody>
                  ...
                  <div className="button-items">
                    ...
                    <Button color="secondary" className="btn btn-secondary btn-sm btn-block ">
                      Block level button
                    </Button>
                  </div>
                </CardBody>
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="mb-3 card-title-desc">
                    ...
                    radio style button toggling. Add <code className="highlighter-rouge">data-toggle="buttons"</code> to
                    a<code className="highlighter-rouge">.btn-group</code> containing those modified buttons to enable
              ...
              <Card>
                <CardBody>
                  ...
                  <p className="mb-3 card-title-desc">
                    ...
                    className as needed to space out groups, buttons, and more.
                  </p>
