            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <Row>
                    <Col md={6}>
                      <img className="rounded ms-2" alt="Skote" width="200" src={img4} />
                    </Col>
                    <Col md={6}>
            ...
            <Col className="col-12">
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    The default media displays a media object (images, video, audio) to the left or right of a content
                    block.
                  </CardSubtitle>
                  <div className="media mb-4">
                    <img className="d-flex me-3 rounded-circle" src={avatar6} alt="Skote" height="64" />
                  ...
                  <div className="media mb-4">
                    <img className="d-flex me-3 rounded-circle" src={avatar2} alt="Skote" height="64" />
                    <div className="media-body">
                      <h5 className="mt-0 font-16">Media heading</h5>
                      Cras sit amet nibh libero, in gravida nulla. Nulla vel metus scelerisque ante sollicitudin. Cras
                      purus odio, vestibulum in vulputate at, tempus viverra turpis. Fusce condimentum nunc ac nisi
                  ...
                  <div className="media">
                    ...
                    <img className="d-flex me-3 rounded-circle" src={avatar4} alt="Skote" height="64" />
                  </div>
                </CardBody>
              </Card>
            </Col>
            ...
            <Col className="col-12">
              <Card>
                <CardBody>
                  ...
                  <div className="media mb-4">
                    <img className="d-flex align-self-start rounded me-3" src={avatar3} alt="Skote" height="64" />
                    <div className="media-body">
                  ...
                  <div className="media mb-4">
                    <img className="d-flex align-self-center rounded me-3" src={avatar5} alt="Skote" height="64" />
                    <div className="media-body">
                  ...
                  <div className="media">
                    <img className="d-flex align-self-end rounded me-3" src={avatar1} alt="Skote" height="64" />
                    <div className="media-body">
