                ...
                <CardBody>
                  <Row>
                    ...
                    <Col lg={6}>
                      ...
                      <CardSubtitle className="mb-3">
                        Use the <code>.rounded-pill</code> modifier className to make badges more rounded (with a larger{' '}
                        <code>border-radius</code>
                        and additional horizontal <code>padding</code>). Useful if you miss the badges from v3.
                      </CardSubtitle>

                      <div>
                        <Badge className="me-1 rounded-pill bg-primary">Primary</Badge>
                        <Badge className="me-1 rounded-pill bg-success">Success</Badge>
                        <Badge className="me-1 rounded-pill bg-info">Info</Badge>
                        <Badge className="me-1 rounded-pill bg-warning">Warning</Badge>
                        <Badge className="me-1 rounded-pill bg-danger">Danger</Badge>
            ...
            <Col lg={6}>
              <Card>
                <CardBody>
                  ...
                  <CardSubtitle className="mb-3">
                    Add small overlay content, like those found in iOS, to any element for housing secondary
                    information.
                  </CardSubtitle>
                  <div className="button-items">
                    <Button
